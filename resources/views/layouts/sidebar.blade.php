<aside class="sidebar">
    <a href="#" class="brand-logo">
        ...
        <div>
            ...
            <small style="font-size: 0.6rem; color: #9ca3af; letter-spacing: 1px; font-weight: 600;">PRIVATE
                BANKING</small>
        </div>
    </a>
    ...
    <ul class="nav-menu">
        ...
        <li class="nav-item"><a href="{{ route('targets.index') }}"
                ...
                Targetku</a></li>
        <li class="nav-item"><a href="{{ route('ai.index') }}" class="nav-link {{ Request::is('ai-assistant*') ? 'active' : '' }}">
    ...
    <div class="sidebar-bottom">
        <ul class="nav-menu">
            <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-question-circle"></i> Support</a>
            </li>
            <li class="nav-item">
